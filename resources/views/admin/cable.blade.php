...
@section('content')
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Cable List</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Cable</a></li>
                                    ...
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="item{{$data->id}}">
                                                <td>{{$data->name}}</td>
                                                <td>{{$data->notes}}</td>
                                                <td>{{($data->status == 1) ? 'Active' : 'Deactive'}} 
                                                </td>
                                                <td>
        ...
        <!-- update Modal -->
          <div class="modal fade" id="edit" role="dialog"  tabindex="-1" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <form action="{{route('cable.update')}}"  method="post">
                      {{ csrf_field() }}
                  <!-- Modal content-->
                  <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Update cable</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
...
@section('js')
    ...
    function deleteItem(id) {
        ...
        var link = '{{route("cable.delete", ":id")}}';
