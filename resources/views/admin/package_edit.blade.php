                                        ...
                                        <div class="row justify-content-md-center">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <input  name="discount" id="discount" value="{{$data->discount}}" placeholder="Enter discount ..." type="text" class="form-control">
                                                </div>
                                            </div>
                                                ...
                                                <div class="head-label">
                                                    ...
                                                    <div  class="status-btn" >
                                                        <div class="custom-control custom-switch">
                                                            <input name="status"  type="checkbox" class="custom-control-input" {{($data->status == 1) ?  'checked' : ''}} id="status">
