            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Payment method List</h4>
                    </div>
            ...
            <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body form-row">
                        <div class="card-body">
                            <form action="{{route('paymentmethod.store')}}" method="POST" class="floating-labels">
                                {{csrf_field()}}
                                <div class="form-body">
                                    <!--/row-->
...
@section('js')
    ...
    <script type="text/javascript">
      ...
      function edit(id){
            ...
            var  url = '{{route("paymentmethod.edit", ":id")}}';
    ...
    function deleteItem(id) {
        ...
        var link = '{{route("paymentmethod.delete", ":id")}}';
