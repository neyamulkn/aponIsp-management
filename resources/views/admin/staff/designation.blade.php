...
@section('content')
        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Designation List</h4>
                </div>
    ...
    <!-- End Page wrapper  -->
    <!-- update Modal -->
    <div class="modal fade" id="add" designation="dialog"  tabindex="-1" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body form-row">
                    <div class="card-body">
                        <form action="{{route('designation.store')}}" method="POST" class="floating-labels">
                            {{csrf_field()}}
                            <div class="form-body">
                                <!--/row-->
                                <div class="row justify-content-md-center">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input  name="designation" id="designation" value="{{old('designation')}}" required="" type="text" class="form-control">
                                        </div>
                                    </div>
                                </div>
    ...
    <!-- update Modal -->
    <div class="modal fade" id="edit" designation="dialog"  tabindex="-1" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        function deleteItem(id) {
            ...
            var link = '{{route("designation.delete", ":id")}}';
