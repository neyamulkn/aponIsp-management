                                    ...
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="item{{$user->id}}">
                                                ...
                                                <td>
                                                    <a href="{{route('user.profile', $user->user->username)}}"   class="btn btn-success btn-sm"><i class="ti-eye" aria-hidden="true"></i></a>

                                                    <a href="{{route('user.edit',$user->id)}}"   class="btn btn-info btn-sm"><i class="ti-pencil" aria-hidden="true"></i></a>
                                                    
                                                    <button data-target="#delete" onclick="confirmPopup('{{ $user->id }}')" class="btn btn-danger btn-sm" data-toggle="modal"><i class="ti-trash" aria-hidden="true"></i></button>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
