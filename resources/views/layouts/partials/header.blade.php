        ...
        <div class="navbar-collapse">
            ...
            <ul class="navbar-nav my-lg-0">
                ...
                <li class="nav-item dropdown u-pro">
                    <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{asset('assets')}}/images/users/1.jpg" alt="user" class=""> <span class="hidden-md-down">
                        @if(Auth::guard('admin')->check()){{Auth::guard('admin')->user()->name}} @endif
                        @if(Auth::guard('vendor')->check()){{Auth::guard('vendor')->user()->vendor_name}} @endif &nbsp;<i class="fa fa-angle-down"></i></span> </a>
